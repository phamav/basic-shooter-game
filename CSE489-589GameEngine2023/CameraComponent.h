...
public:
	...
	void setSkyBox(std::shared_ptr<class SkyBoxComponent> skyBox) { this->skyBox = skyBox; }

	const std::shared_ptr<class SkyBoxComponent> getSkyBox() { return this->skyBox; }
...
protected:
	...
	// Skybox associated with this camera
